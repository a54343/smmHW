$(function () {
    ...
    $("#register_sub").click(function () {
        ...
        //出生日期
        var user_brithday = $.trim($("input[name=user_brithday]").val());
        ...
        if (user_name == null || user_name === "") {
            ...
            return false;
        } else if (user_pwd !== user_password_one) {
            $("#user_password_one").css("border", "1px solid red")
            ...
            return false;
        } else if (user_brithday == null || user_brithday === "") {
